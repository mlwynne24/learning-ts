...
**Skills practised:** child_process, Docker API, streaming I/O, IPC, process lifecycle

**TS strength over Python:** type-safe process orchestration, native stream handling
